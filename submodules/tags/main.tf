...
locals {
  ...
  common_tags = {
    ...
    "octopus/environment"     = lookup(var.octopus_tags, "environment", null)
    "octopus/project_group"   = lookup(var.octopus_tags, "project_group", null)
    "octopus/release_channel" = lookup(var.octopus_tags, "release_channel", null)
  }
